...
Chicago publishes three data sets about Transportation Network Providers operations in the city. This notebook uses jhuuuuuuuuuuuuu4x9i3ytz dfZ       the [Drivers](https://data.cityofchicago.org/Transportation/Transportation-Network-Providers-Drivers/j6wf-834c) data set. All three are updated monthly. I download the Drivers set as a CSV file; the Trips data set is too big for that, and (in other notebooks) I query it from the notebook.
