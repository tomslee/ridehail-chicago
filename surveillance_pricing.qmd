...
abstract: >
  ...
  mind, but data from Chicago shows that Uber used "upfront pricing 
  for riders" to increase fares and to take more from each transaction by 
  fine-tuning prices for each trip. Now the other shoe has dropped, as
  Uber has introduced "upfront pricing for drivers" in Canada, and there 
  can be little doubt it will be used to drive down driver earnings. 
appendix-style: none
